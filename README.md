...
✅ مرتب‌سازی خودکار فایل‌ها بر اساس نوع (عکس، ویدیو، سند و...)  
✅ امکان انتخاب بین **دسته‌بندی پیش‌فرض یا شخصی‌سازی‌شده**  
✅ بدون نیاز به اینترنت یا نصب برنامه خاص  
...
* اضافه شدن انتخاب زبان فارسی و انگلیسی
* امکان انتخاب دسته‌بندی پیش‌فرض یا شخصی‌سازی‌شده
* بهبود تجربه کاربری و ساختار کد
